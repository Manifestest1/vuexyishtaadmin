...
import { getAllFilters, image_base_path } from '../../../../../context/api/apiService'
      ...
      <Grid container>
        <Grid item xs={12} sm={12}>
          <Button
            variant='contained'
            component='label'
            sx={{ mt: 4, mr: 4, display: 'block', width: '140px', float: 'right' }}
          >
            Add Category
          </Button>
        </Grid>
            ...
            {allFilterData &&
              allFilterData.map((data, index) => (
                <TableRow hover key={index} sx={{ '&:last-of-type td, &:last-of-type th': { border: 0 } }}>
                  ...
                  <TableCell>
                    <Button variant='contained' component='label' sx={{ mt: 2, display: 'block', width: '140px' }}>
                      Add Filter
                    </Button>
                  </TableCell>
                </TableRow>
